...
export default function AddProductModalForm(props) {
    const {
        API_URL,
        METHOD,
    } = props.config;
    ...
    return (
        <div className="container pt-3">
            {unitLoad || categoryLoad || materialLoad ? (
                ...
                <form id={`addProductsForm`} onSubmit={handleSubmitProduct(onSubmitProduct)}>
                    ...
                    <div className="d-flex gap-3">
                        ...
                        <div className="flex-fill mb-2">
                            ...
                            <input type="number" className="form-control form-control-sm" id='product_min_stock' min={0} step="0.01"
                                {
