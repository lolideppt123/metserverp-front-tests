...
function SalesOrderEditForm({ config }) {
    ...
    const {
        ...
        defaultValues: {
            ...
            invoice_paid_date:
                dayjs(data?.invoice_paid_date).format("YYYY-MM-DD") || "",
        },
    });
        ...
        setTimeout(async () => {
            try {
                ...
                message =
                    err?.data?.message ||
                    `${err?.status} Code: ${
                        err?.originalStatus || "Call Master Joseph"
                    }` ||
                    "An error occurred";
                variant = "error";
            } finally {
                        ...
                        <div className="row">
                            <div className="col-md-6 border-end border-secondary">
                                ...
                                {errors?.sales_invoice && (
                                    <p
                                        className="text-danger px-1 mt-1 mb-2 text-center"
                                        style={{
                                            fontWeight: "600",
                                            fontSize: "13px",
                                        }}
                                    >
                                        {errors.sales_invoice.message}
                                    </p>
                                )}
