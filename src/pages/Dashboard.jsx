...
export default function Dashboard() {
    const { loading: dashboardLoad, response: dashboard, setResponse: setdashboard, error: dashboardErr, axiosFetch: dashboardDataFetch } = useAxiosFunction();
    ...
    return (
        ...
        <div className="dashboard">
            {dashboardLoad ? (
                ...
                <DashboardModule BoxSM={BoxSM} BoxMD={BoxMD} BoxLG={BoxLG} loading={dashboardLoad} />
            )}
        </div>
    )
}
