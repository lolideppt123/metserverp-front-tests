...
const DeleteMessage = ({record}) => {
    return (
        <div className="d-flex flex-column mb-4">
            <h6 className="text-center h6-text-danger mb-3">You are about to delete a Product Inventory record.</h6>
            <div className="card card-body">
                ...
                <p className=" mb-0 text-muted">
                    ...
                    <span className=''>
                        <RenderText text={record?.product_name || record?.product?.product_name} maxLength={24} />
                    </span>
                </p>
                <p className=" mb-0 text-muted">
                    <span className="h6 pe-1">
